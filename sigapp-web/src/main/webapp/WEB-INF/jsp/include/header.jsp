...
<nav class="navbar navbar-default" role="navigation">
  ...
  <ul class="nav nav-pills nav-stacked">
   ...
   <li class="active" data-toggle="collapse" data-parent="#pv81" href="#pv81">
              <a class="nav-sub-container">SISCAT<b class="caret"></b></a></li>
              <ul class="nav nav-pills nav-stacked collapse" id="pv81">
                <li data-toggle="collapse" data-parent="#p82" href="#p82">
	              <a class="nav-sub-container"> Planimetria<b class="caret"></b></a></li>
	              <ul class="nav nav-pills nav-stacked collapse" id="p82">
		                	<li <c:if test="${menuHeader eq 'Planimetria'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/Planimetria/Provincia.html"><i class="fa fa-indent"></i> Provincias</a></li>
		                	<li <c:if test="${menuHeader eq 'Planimetria'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/Planimetria/Distrito.html"><i class="fa fa-indent"></i> Distrito</a></li>
			            	<li <c:if test="${menuHeader eq 'Planimetria'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/Planimetria/Calles.html"><i class="fa fa-indent"></i> Calles</a></li>
			            	<li <c:if test="${menuHeader eq 'Planimetria'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/Planimetria/Cruces.html"><i class="fa fa-indent"></i> Cruces</a></li>
			            	
			    </ul>
	            <li data-toggle="collapse" data-parent="#p83" href="#p83">
	              <a class="nav-sub-container">Sectores de Abas/Rec<b class="caret"></b></a></li>
	              <ul class="nav nav-pills nav-stacked collapse" id="p83">
		                	<li <c:if test="${menuHeader eq 'Sectores'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/Sectores/Abastecimiento.html"><i class="fa fa-indent"></i> Abastecimiento</a></li>
		                	<li <c:if test="${menuHeader eq 'Sectores'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/Sectores/Recoleccion.html"><i class="fa fa-indent"></i> Recoleccion</a></li>
			            	
			    </ul>
			    <li data-toggle="collapse" data-parent="#p84" href="#p84">
	              <a class="nav-sub-container">Catastro<b class="caret"></b></a></li>
	              <ul class="nav nav-pills nav-stacked collapse" id="p84">
		                	<li <c:if test="${menuHeader eq 'Catastro'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/Catastro/Agua.html"><i class="fa fa-indent"></i> Agua</a></li>
		                	<li <c:if test="${menuHeader eq 'Catastro'}"> class="active"</c:if>><a href="<%=request.getContextPath() %>/PCatastro/Alcantarillado.html"><i class="fa fa-indent"></i> Alcantarillado</a></li>
